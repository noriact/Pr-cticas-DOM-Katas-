...
botonBorrar.textContent = 'Da igual cuantos haya quiero quitar el ultimo'

function eliminarUlti() {
  const divTodos = document.querySelectorAll('div')
  divTodos[divTodos.length - 1].remove()
}
botonBorrar.addEventListener('click', eliminarUlti)
